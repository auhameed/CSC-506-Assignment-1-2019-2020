        ...
        <HashRouter>
            <div>
                <nav className="navbar navbar-inverse navbar-fixed-top">
                    <div className="container-fluid">
                        ...
                        <div className="navbar-header">
                            ...
                            <NavLink className="navbar-brand" to="/"><span className="rwd-line">Home<i className="fa fa-empire" aria-hidden="true"></i></span>
                            </NavLink>
                        </div>
                            ...
                            <ul className="nav navbar-nav navbar-right text-center">
                                ...
                                { profile === '' ?
                                    ...
                                    <>
                                        ...
                                        <li className="contact_btn"><NavLink to="/logout"> LOGOUT</NavLink></li>
                                    </>
                                }
                ...
                <div className="content">
                    ...
                    <Route exact path="/login" component={() => <Login type={1} addProfile={addProfile} profile={profile}  /> } />
                    <Route exact path="/register" component={() => <Login type={2} addProfile={addProfile} profile={profile}   /> }  />
                    ...
                    />
                    <Route exact path="/profile" component={() => <Profile addProfile={addProfile} profile={profile}   /> } />
                </div>
            </div>
        </HashRouter>
    )
